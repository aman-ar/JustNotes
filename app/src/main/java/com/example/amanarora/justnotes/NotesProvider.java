...
/**
 * Created by Aman Arora on 2/20/2016.
 */
public class NotesProvider extends ContentProvider {


    private static final String AUTHORITY = "com.example.justnotes.notesprovider";
    ...
    public final static String CONTENT_ITEM_TYPE = "Note";
